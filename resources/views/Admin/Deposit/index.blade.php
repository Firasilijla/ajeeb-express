...
<div class="card card-custom " id="rtl">
    <div class="card-header flex-wrap py-5">
        <div class="card-title">
            <h3 class="card-label">
                عمليات الايداع في النظام
                <div class="text-muted pt-2 font-size-sm">جميع عمليات الايداع في النظام </div>
            </h3>
        </div>
    ...
    <div class="card-body">
        ...
        <div id="" class="">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline collapsed" id="deposit" role="grid" aria-describedby="kt_datatable_info" style="width: 957px;">
                        <thead style="background-color: #17594A;color:black">
                            ...
                            <!-- <th><span style="color:white;font-weight: bolder;font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;"> صورة الوصل </span> </th> -->
