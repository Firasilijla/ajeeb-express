		...
		<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
			...
			<div id="kt_header_menu" class=" header-menu header-menu-mobile header-menu-layout-default">
				...
				<ul class="menu-nav ">
					...
					<!-- <a href="{{route('admin.admin.logout')}}" class="menu-link  " style="background-color:  rgb(1, 169, 169);">
							<span class="menu-text " style="color: white; font-weight: bold; ">تسجيل خروج</span>
							<i class="menu-arrow"></i>
						</a> -->
						@else
						<!-- <a href="{{route('user.user.logout')}}" class="menu-link  " style="background-color:  rgb(1, 169, 169);">
							<span class="menu-text " style="color: white; font-weight: bold; ">تسجيل خروج</span>
							<i class="menu-arrow"></i>
						</a> -->
						@endif
		...
		<div class="topbar">
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
					<form>
						<!--begin::Header-->
						<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo asset('assets/media/misc/bg-1.jpg') ?>)">
							<!--begin::Title-->
							<h4 class="d-flex flex-center rounded-top">
								<span class="text-white">إشعارات النظام </span>
								<span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2"> جديد 23</span>
							</h4>
							<!--end::Title-->
							<!--begin::Tabs-->
							<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
								<li class="nav-item">
									<a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications">الرسائل</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#topbar_notifications_events">المهام</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#topbar_notifications_logs">الأنشطة</a>
								</li>
							</ul>
							<!--end::Tabs-->
						</div>
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
					<!--begin:Header-->
					<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo asset('assets/media/misc/bg-1.jpg') ?>)">
						<h4 class="text-white font-weight-bold">الوصول السريع </h4>
						<span class="btn btn-success btn-sm font-weight-bold font-size-sm mt-2">أهم الوظائف </span>
					</div>
					<!--end:Header-->
					<!--begin:Nav-->
					<div class="row row-paddingless">
						...
						<div class="col-6">
							<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
								<span class="svg-icon svg-icon-3x svg-icon-success">
									...
									<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Devices\LTE2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
									...
									<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">غرف الإشارة</span>
									<span class="d-block text-dark-50 font-size-lg">دلائل النظام</span>
							</a>
						</div>
						<!--end:Item-->
						<!--begin:Item-->
						<div class="col-6">
							<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
								<span class="svg-icon svg-icon-3x svg-icon-success">
									...
									<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1"> كادر اللواء</span>
									<span class="d-block text-dark-50 font-size-lg">دلائل النظام</span>
							</a>
						</div>
						<!--end:Item-->
						...
						<div class="col-6">
							<a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
								<span class="svg-icon svg-icon-3x svg-icon-success">
									...
									<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Upload-folder.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
									...
									<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">التصديرات</span>
									<span class="d-block text-dark-50 font-size-lg"> تصدير الملفات</span>
							</a>
						</div>
						<!--end:Item-->
						<!--begin:Item-->
						<div class="col-6">
							<a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
								...
								<span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">مستخدمي النظام</span>
								<span class="d-block text-dark-50 font-size-lg">إدارة المستخدمين </span>
							</a>
						</div>
						<!--end:Item-->
					</div>
			...
			<div class="topbar-item">
				<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
					<!-- <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">{{Auth::user()->asker_id}}</span> -->
					<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{Auth::user()->asker_id}}</span>
					<span class="symbol symbol-35 symbol-light-success">
						<span class="symbol-label font-size-h5 font-weight-bold mr-5" style="background-image:url(<?php echo asset(Auth::user()->avatar) ?>)">   <?php ?>    </span>
					</span>
				</div>
			</div>
			<!--end::User-->
