...
<head>
	...
	<style>
		...
		/* .aside *{
	background-color: rgb(6, 41, 49)
}
.aside *:hover,.menu-submenu:hover{
	background-color: rgb(6, 41, 49)
} */
	</style>
	@yield('style')
	...
	<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="d-flex align-items-center mt-5">
				<div class="symbol symbol-100 mr-5" style="margin-right: 10px;">
					<div class="symbol-label" style="background-image:url(<?php echo asset(Auth::user()->picture) ?>)"></div>
				...
				<div class="d-flex flex-column">
					...
					<div class="navi mt-2">
						...
						<a href="{{route('admin.admin.logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">تسجيل خروج </a>
						@else
						<a href="{{route('user.user.logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">تسجيل خروج </a>
						@endif
					</div>
				</div>
			</div>
			...
			<div class="navi navi-spacer-x-0 p-0">
				...
				<form action="" method="post" enctype="multipart/form-data" class="navi-item">
				   @csrf
					...
					<div class="navi-link">
						...
						<div class="navi-text">
							...
							<div class="text-muted">إعدادات الملف الشخصي
								<input type="submit" value="تعديل" class="label label-light-danger  btn btn-danger label-inline font-weight-bold">
				...
				<a href="custom/apps/user/profile-2.html" class="navi-item">
					<div class="navi-link">
						...
						<div class="navi-text">
							<div class="font-weight-bold">الأنشطة </div>
							<div class="text-muted"> الأنشطة داخل النظام </div>
						</div>
					</div>
				</a>
				<!--end:Item-->
				...
				<a href="custom/apps/userprofile-1/overview.html" class="navi-item">
					<div class="navi-link">
						...
						<div class="navi-text">
							<div class="font-weight-bold">المهام </div>
							<div class="text-muted"> المهام عليك تنفيذها </div>
						</div>
					</div>
				</a>
				<!--end:Item-->
