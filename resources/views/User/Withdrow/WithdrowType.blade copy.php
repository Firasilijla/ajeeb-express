        ...
        <div class="page__content page__content--with-header page__content--with-bottom-nav">
            ...
            <div class="page-inner">
                ...
                <div class="cards cards--11">
                    ...
                    <a class="card-coin" href="{{route('user.Withdrow.WithdrowIndexUser')}}">
                        <div class="card-coin__logo">
                            <img src="{{asset('userassets/img/logos/tether.png')}}" alt="" title="" /><span>USDT <b></b></span>
                        </div>
                        <div class="card-coin__price"> <strong id="USDT"> <?php

echo (Auth::user()->is_trading =='0') ? Auth::user()->total_amount.'$' : '0 $'; ?></strong></div>
                    </a>
