        ...
        <div class="d-flex align-items-center justify-content-center p-10" style="width: 100%;">
            <div class="card card-custom  ">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-4">
                        <!--begin::Image-->
                        <div id="Qr_image_btc" style="height:260px;background-position: center;background-size: contain;background-repeat: no-repeat;"></div>
                        ...
                        <!--begin::Text-->
                        <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-2 copy-text text-center" id="Qr_address_btc">
                        </p>
                        <!--end::Text-->
                    ...
                    <div class="col-md-12">
                        <form class="d-flex flex-column align-items-center" enctype="multipart/form-data" id="myForm">
                            ...
                            <input type="button" value="Deposit" class="form-control btn btn-warning mt-5" id="deposit">
    ...
    $(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#Qr_address_btc").text(res.Qr_address_btc);
