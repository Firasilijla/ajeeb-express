        ...
        <div class="d-flex align-items-center justify-content-center  p-10" style="width: 100%;">
            <div class="card card-custom  ">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-40 symbol-light-primary mr-5">
                            <span class="symbol-label">
                                <img src="{{asset('userassets/img/logos/lti.png')}}" class="h-75 " alt="">
                            </span>
                        </div>
                    ...
                    <div class="pt-4">
                        <!--begin::Image-->
                        <div id="Qr_image_ltc" style="background-image: url('http://127.0.0.1:8000/assets/media/images/QR/6tqISF03JuavPeB446n9rVKoHvHCVJ8vzXcWmoSl.png');height:260px;background-position: center;background-size: contain;background-repeat: no-repeat;"></div>
                        ...
                        <!--begin::Text-->
                        <p class="text-dark-75 font-size-lg font-weight-normal pt-5 mb-2 copy-text text-center" id="Qr_address_ltc">
                    ...
                    <div class="col-md-12">
                        <form class="d-flex flex-column align-items-center" enctype="multipart/form-data" id="myForm" >
                            ...
                            <input type="button" value="Deposit" class="form-control btn btn-primary mt-5" id="deposit">
    ...
    $(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#Qr_address_ltc").text(res.Qr_address_ltc);
