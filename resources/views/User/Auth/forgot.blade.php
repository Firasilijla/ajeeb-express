                ...
                <div class="card-body p-5">
                    <form action="#" method="POST" id="forgot_form">
                        ...
                        <div class="mb-3 text-secondary">
                            Enter Your E-email address and we will send you a liinke to reset your password
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-grid">
                            <input type="submit" value="Reset Passsword" class="btn btn-dark rounded-0" id="forgot_btn">
                        </div>
